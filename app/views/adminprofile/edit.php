          ...
          <div class="card-body">
            <form action="<?php echo URLROOT; ?>/adminProfile/edit" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input id="nom" type="text" name="name" class="form-control <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['currentUser']->name; ?>">
                <span class="invalid-feedback">
                  <?php echo $data['name_err']; ?></span>
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input id="email" type="email" name="email" class="form-control <?php echo (!empty($data['email_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['currentUser']->email; ?>">
                <span class="invalid-feedback">
